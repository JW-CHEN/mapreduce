...
public class HadoopDriver {
	...
	public static void main(String[] args) {
		...
		if(args.length == 2) {
			...
			/*RatingStarYearMapper puts (Text, IntWritable) */
			conf.setMapOutputKeyClass(Text.class);
			conf.setMapOutputValueClass(IntWritable.class);
			
			/* StarPerYearReducer outputs (Text, IntWritable) */
			...
			conf.setMapperClass(RatingStarYearMapper.class);
			//conf.setCombinerClass(UserRatingMapper.class);
			conf.setReducerClass(StarPerYearReducer.class);
